...
export class OllamaGateway implements AnalysisGateway {
  ...
  async analyze(message: SyncMessage): Promise<MessageAnalysis> {
    ...
    if (
      ...
      "targetEventId" in proposedAction &&
      message.candidates?.length
    ) {
      const targetEventId = (proposedAction as { targetEventId: string })
        .targetEventId;
